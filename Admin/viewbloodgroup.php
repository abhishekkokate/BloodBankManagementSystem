                ...
                <div style="margin:auto; width:100%;">
                    <div class="field">
                        <div class="BMSTitle" style="margin-bottom: 2rem;">
                            <h2>View Blood Groups</h2>
                        </div>
                    </div>
                    <div>
                        <table border="1" align="center" width="80%" height="200px" style="margin: auto;">
                            <tr>
                                <td style='margin: auto; text-align: center; background: rgb(151 133 36 / 34%);'>Blood
                                    Group Id </td>
                                <td align="center"
                                    style='margin: auto; text-align: center; background: rgb(151 133 36 / 34%);'>
                                    Blood Group Name</td>
                            </tr>
                            <tr>
                                <td>
