            ...
            <form method="post">
                <div style="margin:auto; width: 300px;">
                    ...
                    <table border="1" align="center" width="80%" height="200px" style="margin: auto;">
                        <tr>
                            <td style='margin: auto; text-align: center; background: rgb(151 133 36 / 34%);'>State Id
                            </td>
                            <td style='margin: auto; text-align: center; background: rgb(151 133 36 / 34%);'>State Name
                            </td>
                        </tr>
                        <?php
