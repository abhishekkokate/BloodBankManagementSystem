...
?>
            ...
            <form method="post">
                <div style="margin:auto; width:100%;">
                    ...
                    <div class="field">
                        <input type="text" name="t3" required="required" placeholder="Enter City Name"
                            title="please enter only character between 5 to 15 for city name" />
                    </div>
                    <div class="field">
                        <input type="number" name="t2" required="required" placeholder="Pin Code"
                            title="please enter only numbers between 6 to 10 for pin code" />
                    </div>
                    <div class="field">
                        <input type="text" name="t1" required="required" placeholder="District"
                            title="please enter only character between 5 to 15 for city name" />
                    </div>
                    <div class="field">
