...
?>
                    ...
                    <div class="field">
                        <span class="lefttd">State Name</span>
                        <input type="text" value="<?php  if(isset($_POST["show"])){ echo $state_name ;}    ?>" name="t2"
                            required="required" pattern="{5,18}"
                            title="please enter only character  between 5 to 18 for state name" />
                    </div>
                    <div class="field">
