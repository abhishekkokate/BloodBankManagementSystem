            ...
            <div style="width:800px;float:left">
                ...
                <form method="post" enctype="multipart/form-data">
                    <table border="0" align="center" width="400" height="300px" class="shaddoww">
                        <tr>
                            <td colspan="2" align="center" class="toptd">Add Advertisement </td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="lefttd">Camp Title</td>
                            <td><input type="text" name="t3" required="required" pattern="[a-zA-Z0-9 _]{5,35}"
                                    title="please enter only character or numbers between 5 to 35 for camp title" />
                            </td>
                        </tr>
                        <tr>
                            <td class="lefttd">Organized By</td>
                            <td><input type="text" name="t2" required="required" pattern="[a-zA-Z0-9 _]{5,35}"
