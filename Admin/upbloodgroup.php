                ...
                <div style="margin:auto; width:100%;">
                    <div class="field">
                        <div class="BMSTitle" style="margin-bottom: 2rem;">
                            <h2>Upgrade Blood Group</h2>
                        </div>
                    </div>
                    <div class="field"><span>
                            <span class="lefttd">Select Blood Group </span>
...
?>
                    ...
                    <div class="field">
                        <input type="text" name="t2" placeholder="Bloog Group Name"
                            value="<?php  if(isset($_POST["show"])){ echo $bg_name ;}    ?>" required="required" />
                    </div>
                    </span>
                </div class="field">
